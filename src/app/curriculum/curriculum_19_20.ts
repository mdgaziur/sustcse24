  ...
  [
    [
      {
        ...
        "credits": 3.0,
        "contact_hours": 3,
        "details": "<b>Programming Language:</b> Basic concept, Overview of programming languages, Problem Solving Techniques and Data Flow Diagram.<br/><br/><b>C-Language:</b> Preliminaries, Program constructs, variables and data types in C.<br/><br/>Input and output. Character and formatted I/O; Arithmetic Expressions and Assignment statements; Control statement, Loops and Nested loops; break, continue, goto, Decision making; Arrays, Functions; Arguments and local variables, Calling Functions and arrays. Recursion and Recursive functions; Structures within structure. Automatic, external, static variable, Files; File functions for sequential and Random I/O. Pointers; Pointers and structures, union; Pointer and functions, Pointer and arrays; Operation and Pointer; Pointer and memory addresses; Operations on Bits; Bit Operation; Bit field; Advanced features; Preprocessor and Macros, enumeration, Standard library.<br/><br/><b>Recursion:</b> Basic idea of recursion (3 laws-base case, call itself, move towards base case by state change), tracing output of a recursive function, applications: factorial, fibonacci, tower of Hanoi, merge sort, permutation, combination.<br/><br/><b>Sorting:</b> Insertion sort, selection sort, bubble sort, merge sort, quick sort, distribution sort(counting soft, radix sort, bucket sort).<br/><br/><b>Searching:</b> Linear search, binary Search, application of Binary Search- finding element in a sorted array, finding nth root of a real number, solving equations.<br/><br/><b>Stack and Queue:</b> Basic stack operations (push/pop/peek), stack-class implementation using Array and linked list, in-fix to post-fix expressions conversion and evaluation, balancing parentheses using stack, basic queue operations (enqueue, dequeue), circular queue/ dequeue, queue-class implementation using array and linked list, application- Josephous problem, palindrome checker using stack and queue.",
        "textbooks": [
      ...
      },
      {
        ...
        "credits": 3.0,
        "contact_hours": 6,
        "details": "<b>Introduction:</b> Introductory outputs using C.Data Types &Operator. Declaring variablesof different data types and doing different types of operations on them, facing problems when internal result of calculation crosses the boundary of a data type.<br/><br/><b>DataInput/Output:</b> Variation and formats of getting input and giving output.<br/><br/><b>Control Statement:</b> Implementation of all types of controlstatement structures.<br/><br/>odd/even test, find max/min from 2/3 numbers, generate grades from marks, floor, ceiling, absolute value, sum of n numbers using loop and calculate average, test prime, generate Fibonacci sequence.<br/><br/><b>Array, String and Nested Looping:</b> Finding the number of students getting marks above average, finding vowel and consonant from a given string, detecting palindrome, counting words of a string, reversing each words of a sentence, using different functions inctions of string h library, bubble sort, matrix multiplication,<br/><br/><b>Using Library Functions:</b> Functions from stdio.h, math.h, stdlib.h and ctype.h library. Functions: Doing some previous problemsusing function, implement call by value and call by references, prime factorization.<br/><br/><b>Recursion:</b> Find Greatest Common Divisor, Fibonacci, Factorial, Tower of Hanoi. Program Structure: Use static and global variable.<br/><br/><b>Pointers:</b> Passing pointer to a function, dynamic memory allocation, arrays of pointers. Structure and Union: Sorting points (first according to x, then according to y), using line segment structure, using union.<br/><br/><b>File:</b> Opening, closing, creating and processing data files.<br/><br/><b>Number Theory:</b> Prime Generation, Sieve and How to Optimize, Prime factorization, Factorial Factors, sum of divisor, number of divisor, Big Mod.<br/><br/><b>Recursion:</b> Basic idea of recursion (3 laws-base case, call itself, move towards base case by state change), tracing output of a recursive function, applications: factorial, fibonacci, tower of Hanoi, merge sort, permutation, combination.<br/><br/><b>Sorting:</b> Insertion sort, selection sort, bubble sort, merge sort, quick sort, distribution sort(counting sort, radix sort, bucket sort).<br/><br/><b>Searching:</b> Linear search, binary Search, application of Binary Search- finding element in a sorted array, finding nth root of a real number, solving equations.<br/><br/><b>Stack and Queue:</b> Basic stack operations (push/pop/peek), stack-class implementation using Array and linked list, in-fix to post-fix expressions conversion and evaluation, balancing parentheses using stack, basic queue operations (enqueue, dequeue), circular queue/ dequeue, queue-class implementation using array and linked list, application-Josephous problem, palindrome checker using stack and queue.",
        "textbooks": [],
        "references": [],
        "prerequisites": []
      },
      {
        ...
        "credits": 3.0,
        "contact_hours": 3,
        "details": "<b>Set, Relations, Functions:</b> Set, Function, Representing Relations, Equivalence Relations.<br/><br/><b>Propositional Calculus:</b> Propositions, Predicate and Quantifier.<br/><br/><b>Algorithms:</b> Complexity, Divisions, Algorithm, Application of Number Theory.<br/><br/><b>Recursion:</b> Sequences and summations, Recursive Definition and algorithm.<br/><br/><b>Combinatorial Analysis:</b> Permutation and Combination, Divide and Conquer Algorithms, Generating Functions.<br/><br/><b>Graphs:</b> Representation, Isomorphism, Connectivity, Euler and Hamilton path, Shortest path, Planer, Coloring.<br/><br/><b>Trees:</b> Spanning trees, Rooted Trees, Binary Trees, Huffman Trees.<br/><br/><b>Boolean Algebra:</b> Number System, Boolean Function, representing Boolean Function, Logic gate, Minimization of Circuits.",
        "textbooks": [
      ...
      },
      {
        ...
        "credits": 1.5,
        "contact_hours": 3,
        "details": "In this course students will perform experiments to verify practically the theories and concepts learned in EEE-109.<br/><br/><ol><li>To familiar with the operation of different electrical instruments.</li><li>To verify the following theorems:<br/><br/><ul><li>KCL and KVL theorem,</li><li>Superposition theorem,</li><li>Thevenin's theorem,</li><li>Norton's theorem and</li><li>Maximum power transfer theorem</li></ul></li><li>RL and RC response.</li><li>Study the frequency response of an RLC circuit and find its resonant frequency.</li><li>Basic electrical element like fan, bulb, calling bell etc connection from 220v AC single phase supply.</li><li>Relevant application based on EEE 109.</li></ol>",
        "textbooks": ["Introductory circuit analysis by Boylestad"],
        "references": [
          "Networks, lines and fields by J. D. Ryder",
          "Alternating Current Circuits by Russel M. Kerchner, George F. Corcoran"
      ...
      },
      {
        ...
        "credits": 1.0,
        "contact_hours": 2,
        "details": "<b>Objectives:</b><br/><br/><ol><li>To develop students awareness of standard English pronunciation</li><li>To develop students understanding of the variations in pronunciation</li><li>To develop students ability to use conversational English</li></ol><b>Contents:</b><br/><br/><ul><li>English phonemes, Varieties of English, English stress and intonation, Dialogue, debate, extempore speech, interview, role-play, presentation.</li></ul>",
        "textbooks": [],
        "references": [],
        "prerequisites": []
      },
    ...
    [
      ...
      },
      {
        ...
        "credits": 1.0,
        "contact_hours": 2,
        "details": "<b>Objectives:</b><br/><br/><ul><li>Any project based on C language including implementation of Data Structure is acceptable. Gaming project using graphics.h library in C is preferable. Teachers must have to ensure every project is unique. Innovative project idea should get extra weight to prevent imitating old projects.</li></ul>",
        "textbooks": [],
        "references": [],
        "prerequisites": []
      },
