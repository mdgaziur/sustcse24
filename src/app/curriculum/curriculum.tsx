    ...
    return (
        <div className="min-h-screen flex flex-col items-center">
            ...
            <div className="flex-1 flex flex-col items-center gap-5 p-5 w-full">
                ...
                <a className="p-1 text-md font-semibold border-1 rounded-sm hover:bg-[#e0e0e0] hover:text-[#0e0e0e] transition-all" href={"./curriculum_19-20.pdf"} target="_blank" download={true}>Download Curriculum</a>
                <div className={"max-w-full overflow-x-auto"}>
                    <table className={"max-w-2xl w-auto sm:text-sm text-[12px]"}>
                        <thead>
                        <tr>
